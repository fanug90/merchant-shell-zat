...
export class OnboardingApiService {
  ...
  requestPhoneOtp(request: PhoneOtpRequest): Observable<PhoneOtpResponse> {
    return this.http.post<PhoneOtpResponse>(this.url('/v1/onboarding/phone/otp'), request);
  }
  ...
  getOnboardingState(): Observable<OnboardingStateResponse> {
    return this.http.get<OnboardingStateResponse>(this.url('/v1/onboarding'), this.authOptions());
  }

  submitBusinessDetails(request: BusinessDetailsRequest): Observable<MerchantResponse> {
  ...
  uploadKycDocument(
    ...
    const params = new HttpParams().set('documentType', documentType).set('side', side);
  ...
  linkBankAccount(request: BankAccountLinkRequest): Observable<BankAccountResponse> {
  ...
  selectSettlementAccount(bankAccountId: string): Observable<BankAccountResponse> {
  ...
  submitOnboarding(request: OnboardingSubmitRequest): Observable<OnboardingSubmitResponse> {
